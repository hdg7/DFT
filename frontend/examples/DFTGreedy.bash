...
#	python3 $DFT_HOME/frontend/execution/dft.Greedy.py $TESTFILE mainFake  $INSTRUMENTED.clean.z3 $INPUTS
	python3 $DFT_HOME/frontend/generation/dft.Greedy.py $TESTFILE $TESTFILE  $INSTRUMENTED.clean.z3 mainFake $INPUTS
