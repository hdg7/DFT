...
for INSTRUMENTED in `ls $NAME.pre.c*L*.cbmc.c`
do
	...
	python3 $DFT_HOME/frontend/generation/gen.py randPareto $INSTRUMENTED $TESTFILE $FUNC $INPUTS $INSTRUMENTED.clean.z3
	python3 $DFT_HOME/frontend/execution/set.inputs.py obs $TESTFILE $FUNC $INSTRUMENTED.inputs $INPUTS $RANDOM  
